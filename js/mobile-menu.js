document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".melody-navigation-list");
  const headerRef = document.querySelector(".melody-header");
  const navigationRef = document.querySelector(".melody-navigation");
...
function toggleAnswer(element) {
  ...
  const buttonImg = element.querySelector(".melody-toggle-button img");
